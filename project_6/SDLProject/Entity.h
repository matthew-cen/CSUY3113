...
enum EntityDirection {LEFT, RIGHT, DOWN, UP, NONE};
extern Mix_Chunk* sword_swing2;
...
struct MoveDirection {
    EntityDirection x = NONE;
    EntityDirection y = NONE;
};

class Entity {
public:
    EntityType entityType;
    EntityMoveState moveState = IDLE;
    EntityDirection face_dir = LEFT; // direction of sprite
    MoveDirection move_dir; // direction of x,y movement
    AIState aiState;
    AIType aiType;
    ...
    void SetXDirection(enum EntityDirection newXDir);
    void SetYDirection( enum EntityDirection newYDir);
